...
const ActivityRole = ({ transaction, price, from, to, date }) => {
  return (
    <tr className="overflow-auto text-2xl bg-white border-b rounded-b-lg dark:bg-gray-800 dark:border-gray-700">
      <th
        scope="row"
...
const ActivityTable = () => {
  return (
    <div className="relative overflow-x-auto shadow-md">
      <table className="w-full text-lg text-left text-gray-500 rounded-b-lg dark:text-gray-400">
