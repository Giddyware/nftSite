...
import profile from "../assets/cover/marketplace_profile.jpg";
      ...
      <div className="m-10 mt-20">
          ...
          <div className="flex flex-wrap text-[14px]">
            <p className="mr-6">
              ...
              <span className="font-bold">
                {formatToThousand(nfts?.results * 23)}
              </span>
            </p>
        ...
        <div className="flex gap-6 flex-wrap text-[14px]">
          <p className="flex flex-col mr-6">
            <span className="font-bold">
              {formatToThousand(nfts?.results * 87)} ETH
            </span>
          ...
          <p className="flex flex-col mr-6">
            <span className="font-bold">
              {Number(formatToThousand(nfts?.results * 23 * 0.3)).toFixed(2)}
            </span>
            <span>owners</span>
          </p>
          <p className="flex flex-col mr-6">
