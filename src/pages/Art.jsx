    ...
    <div className="relative w-full h-screen">
      ...
      >
        ...
        <div className="w-36 h-36 md:w-48 md:h-48 rounded border-4 md:rounded-3xl absolute bottom-[-32px] left-10">
          <img src={profile} className="w-full h-full rounded md:rounded-3xl" />
        </div>
      </div>
      <div className="m-10 mt-20">
          ...
          <div className="flex flex-wrap text-[14px]">
            <p className="mr-6">
              ...
              <span className="font-bold">
                {" "}
                {formatToThousand(art?.results * 23)}
              </span>
            </p>
        ...
        <div className="flex gap-6 flex-wrap text-[14px]">
          <p className="flex flex-col mr-6">
            <span className="font-bold">
              {formatToThousand(art?.results * 87)} ETH
            </span>{" "}
          ...
          <p className="flex flex-col mr-6">
            <span className="font-bold">
              {Number(formatToThousand(art?.results * 23 * 0.3)).toFixed(2)}
            </span>
            <span>owners</span>
          </p>
          <p className="flex flex-col mr-6">
